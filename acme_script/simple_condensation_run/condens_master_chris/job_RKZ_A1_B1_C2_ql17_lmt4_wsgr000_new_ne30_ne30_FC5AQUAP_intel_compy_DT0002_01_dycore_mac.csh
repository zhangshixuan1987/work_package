...
setenv CASE      'RKZ_A1_B1_C2_ql17_lmt4_wsgr000_new_ne30_ne30_FC5AQUAP_intel_compy_DT0002_01_dycore_mac'
setenv CASEROOT  '/compyfs/zhan391/e3sm_simulation/cnvg_condens_master_chris/cases/RKZ_A1_B1_C2_ql17_lmt4_wsgr000_new_ne30_ne30_FC5AQUAP_intel_compy_DT0002_01_dycore_mac'
setenv RUNDIR    '/compyfs/zhan391/e3sm_simulation/cnvg_condens_master_chris/run/RKZ_A1_B1_C2_ql17_lmt4_wsgr000_new_ne30_ne30_FC5AQUAP_intel_compy_DT0002_01_dycore_mac'
...
#@ nlen = 3600 / 2   # run model for 60 minutes.
#set stop_o = 'nsteps'

#@ nhtfrq  = 1800 / 2    # output every 30 minutes
#set mfilt = 1                # 1 time step per file 
