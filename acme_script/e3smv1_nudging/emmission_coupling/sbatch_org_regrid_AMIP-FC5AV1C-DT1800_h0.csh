...
set irS = 1
set irE = 1
set casestr = "AMIPNUDG_F20TRC5-CMIP6_default"
...
set RUN_FILE_DIR  = /compyfs/zhan391/emmission_coupling/run
#Output climo files in FV grid
set REGRIDDED_DIR = /compyfs/zhan391/emmission_coupling/regrid/${rgdstr}
