...
set casename = v1_DRIB_RadCPL_4KSST_1yr_DT`printf "%04d" ${dtime}`_${COMPSET}_compy

#-----------------
#setup branch run information
set run_refcase = "NDGDAT_FC5AV1C-L_compy"
set run_refdate = "0001-08-16"
set run_strdate = "0000-10-01"
set run_reftod  = "00000"
set initDir     = "/compyfs/zhan391/e3smv1_drib_radcpl_tsen/run/$run_refcase"
set sstdata     = "/compyfs/inputdata/atm/cam/sst/sst_HadOIBl_bc_1x1_clim_p4k_c20180502.nc"
...
###copy the required restart files to the directory for branch run#####
  ...
  #ln -sf ${initDir}/${lndrin}  $RUNDIR/${lndrin}
   ...
   ./xmlchange  -file env_run.xml -id SSTICE_DATA_FILENAME -val $sstdata
