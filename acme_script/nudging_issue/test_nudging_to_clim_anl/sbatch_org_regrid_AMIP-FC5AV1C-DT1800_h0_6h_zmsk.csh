...
set irS = 1
set irE = 1
set casestr = "AMIP_ANL_NDG_6h_TER_F20TRC5-CMIP6"
set rgdstr  = "AMIP_ANL_NDG_6h_TER_F20TRC5-CMIP6"
...
#Mapping file
set MAP_FILE     = /compyfs/zhan391/acme_init/mapping_ne30_to_1x1.nc  #map_ne30np4_to_0.9x1.25_aave_110121.nc
#location of model history file
set RUN_FILE_DIR  = /compyfs/zhan391/TEST_F20TRC5-CMIP6_NUDG_ISSUE/run
#Output climo files in FV grid
set REGRIDDED_DIR = /compyfs/zhan391/TEST_F20TRC5-CMIP6_NUDG_ISSUE/regrid/${rgdstr}
...
while ( $idtime <= $ndtime )
  ...
  while ( ${id} <= ${irE} )
   ...
   foreach file (*cam.h1* *cam.h2* *cam.h3* *cam.h4*)
