...
set CASE_NAME  = AMIP_ANL_NDG_6h_TER_F20TRC5-CMIP6_DT1800
set start_year = 2010
set end_year   = 2010
...
set RUN_FILE_DIR  = /compyfs/zhan391/TEST_F20TRC5-CMIP6_NUDG_ISSUE/run/$CASE_NAME

#Output climo files in SE grid
set OUT_DIR       = /compyfs/zhan391/TEST_F20TRC5-CMIP6_NUDG_ISSUE/run/se_climo/$CASE_NAME

#Output climo files in FV grid
set REGRIDDED_DIR = /compyfs/zhan391/TEST_F20TRC5-CMIP6_NUDG_ISSUE/run/climo/$CASE_NAME
