...
set casename = PI_AMIP_REV_UVNDG_6h_${COMPSET}_DT`printf "%04d" ${dtime}`
...
set ndg_refcase = AMIP_NDG_DATA_F20TRC5-CMIP6_DT`printf "%04d" ${dtime1}`
set run_refcase = NDRB_NUDG_DATA_F20TRC5-CMIP6_DT1800
                  #AMIP_NDG_DATA_F20TRC5-CMIP6_DT`printf "%04d" ${dtime1}`
setenv initDir /compyfs/zhan391/acme_init/$run_refcase/
...
cat <<EOF >> user_nl_cam
 ...
 !.......................................................
  ...
  Nudge_Curr   = .True.
  Num_Slice    = 1
  Nudge_Path   = '${INPUT_NUDGING}/${ndg_refcase}/'
  Nudge_File_Template = '${ndg_refcase}.cam.h1.%y-%m-%d-%s.nc'
