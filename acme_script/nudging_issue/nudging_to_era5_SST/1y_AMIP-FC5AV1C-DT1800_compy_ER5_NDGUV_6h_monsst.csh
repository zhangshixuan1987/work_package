...
set casename = AMIP_ANL_UVNDG_6h_MONTHSST_${COMPSET}_DT`printf "%04d" ${dtime}`
...
###copy the required restart files to the directory for branch run#####
   ...
   ./xmlchange  -file env_run.xml -id SSTICE_YEAR_ALIGN -val "1869"
   ./xmlchange  -file env_run.xml -id SSTICE_YEAR_START -val "1869"
