...
set job_name       = DECKv1b_A1
set compset        = F20TRC5-CMIP6
...
### CUSTOM CASE_NAME
set case_name = 20180316.${job_name}.ne30_oEC.edison
...
set restart_files_dir = /global/cscratch1/sd/tang30/ACME_simulations/20180316.DECKv1b_A1.ne30_oEC.edison/init/1870-01-01-00000
...
#-----------------------------------------------------------------------------------------------
  ...
  acme_print 'Copying stuff for hybrid run'
  ...
  cp ${restart_files_dir}/rpointer.{atm,drv,lnd} $case_run_dir
