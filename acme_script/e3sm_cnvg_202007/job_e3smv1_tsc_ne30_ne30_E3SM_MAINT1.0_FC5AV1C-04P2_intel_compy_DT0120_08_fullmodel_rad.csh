...
setenv CASE      'e3smv1_tsc_ne30_ne30_E3SM_MAINT1.0_FC5AV1C-04P2_intel_compy_DT0120_08_fullmodel_rad'
setenv CASEROOT  '/compyfs/zhan391/e3sm_simulation/e3sm_mam_cnvg/cases/e3smv1_tsc_ne30_ne30_E3SM_MAINT1.0_FC5AV1C-04P2_intel_compy_DT0120_08_fullmodel_rad'
setenv RUNDIR    '/compyfs/zhan391/e3sm_simulation/e3sm_mam_cnvg/run/e3smv1_tsc_ne30_ne30_E3SM_MAINT1.0_FC5AV1C-04P2_intel_compy_DT0120_08_fullmodel_rad'
...
set dtime    = 120
set atm_init = /compyfs/zhan391/acme_init/FC5AV1C-04P2_init_201907/FC5AV1C-04P2_ne30_ne30_intel_cori-knl.cam.i.0001-08-01-00000.nc
set lnd_init = /compyfs/zhan391/acme_init/FC5AV1C-04P2_init_201907/FC5AV1C-04P2_ne30_ne30_intel_cori-knl.clm2.r.0001-08-01-00000.nc

set ncycle   = 1          # 1 cycle in total, i.e., no restart

@ nlen = 2 * 3600 / 120   # run model for 60 minutes.
set stop_o = 'nsteps'

@ nhtfrq  = 1800 / 120   # output every 30 minutes
set mfilt = 1               # 1 time step per file 

@ nhtfrq1 = 60  / 120     # output every 24s 
@ mfilt1  = 360 / 60         # 1 time step per file 
#@ nhtfrq1  = 1
#@ mfilt1   = 360 / 120     # 1 time step per file
