...
set groupList = ("e3smv1_tsc")
set dtimeList = (1800 450 120 30 12 6 1)
...
set irS = 5    # ensemble member: start index
set irE = 10   # ensemble member: end   index
