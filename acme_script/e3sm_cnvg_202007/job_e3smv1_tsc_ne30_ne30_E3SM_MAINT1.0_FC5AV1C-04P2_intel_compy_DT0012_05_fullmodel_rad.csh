...
setenv CASE      'e3smv1_tsc_ne30_ne30_E3SM_MAINT1.0_FC5AV1C-04P2_intel_compy_DT0012_05_fullmodel_rad'
setenv CASEROOT  '/compyfs/zhan391/e3sm_simulation/e3sm_mam_cnvg/cases/e3smv1_tsc_ne30_ne30_E3SM_MAINT1.0_FC5AV1C-04P2_intel_compy_DT0012_05_fullmodel_rad'
setenv RUNDIR    '/compyfs/zhan391/e3sm_simulation/e3sm_mam_cnvg/run/e3smv1_tsc_ne30_ne30_E3SM_MAINT1.0_FC5AV1C-04P2_intel_compy_DT0012_05_fullmodel_rad'
...
@ nlen = 2 * 3600 / 12   # run model for 60 minutes.
set stop_o = 'nsteps'

@ nhtfrq  = 1800 / 12   # output every 30 minutes
set mfilt = 1               # 1 time step per file 

@ nhtfrq1 = 60  / 12     # output every 24s 
@ mfilt1  = 360 / 60         # 1 time step per file 
#@ nhtfrq1  = 1
#@ mfilt1   = 360 / 12     # 1 time step per file
