...
setenv RESOLUTION ne30_ne30  #ne30_ne30 #ne30_oECv3
setenv MACH compy
setenv COMPILER intel
setenv scheduler 'PBS'

setenv NTASKS_PER_INST  48
setenv NINST  20
setenv NTHRDS 1
...
set casename = SPIN_ENS_${COMPSET}_${RESOLUTION}_DT`printf "%04d" ${dtime}`
set MULTI_DRIVER = ' '
...
set atm_init    = "${CSMDATA}/atm/cam/inic/homme/cami_mam3_Linoz_ne4np4_L72_c160909.nc"
set lnd_init    = "${CSMDATA}/lnd/clm2/initdata_map/clmi.ICRUCLM45.ne4_oQU240.1155ba0.clm2.r.nc"
set lnd_surf    = "${CSMDATA}/lnd/clm2/surfdata_map/surfdata_ne4np4_simyr2000_c160614.nc"
set lnd_use     = "${CSMDATA}/lnd/clm2/surfdata_map/landuse.timeseries_ne4np4_hist_simyr1850_2015_c20171018.nc"
