...
setenv COMPSET  'FAMIP'
setenv CCSMROOT '/compyfs/zhan391/code/E3SM_CAM4_SGR'
setenv PTMP     '/compyfs/zhan391/dart_e3sm_cam4'
setenv EXEDIR   '/compyfs/zhan391/dart_e3sm_cam4/exe/compile_E3SM_CAM4_SGR_FAMIP_1.9x2.5_gx1v6_compy_intel_96proc'
setenv CSMDATA  '/compyfs/zhan391/acme_init/csmdata'
         
setenv CASE      'dart_e3sm_en40_1.9x2.5_gx1v6_DT1800'
setenv CASEROOT  '/compyfs/zhan391/dart_e3sm_cam4/cases/dart_e3sm_en40_1.9x2.5_gx1v6_DT1800'
setenv RUNDIR    '/compyfs/zhan391/dart_e3sm_cam4/run/dart_e3sm_en40_1.9x2.5_gx1v6_DT1800'
...
set nhtfrq    = -24              # monthly average
set mfilt     = 1                # 1 time step per file 

set nl_file = /compyfs/zhan391/run_script/dart_e3sm_test/namelist_files/cam_nl_dart_e3sm_en40
#====================================================================
