...
# there will be 3 restarts when there are only 2 acme.log files,
...
if ($#log_list >= 3) then
   ...
   if ($#re_list < 3) then
      echo "Not enough restart sets, even though there are $#log_list acme.log files"
      exit 14
   endif
...
set ATM_HISTORY_FILENAME = ${CASE}.cam_0001.h1.${ATM_DATE_EXT}.nc
...
# $URL: https://svn-dares-dart.cgd.ucar.edu/DART/releases/Manhattan/models/cam-fv/shell_scripts/cesm1_5/assimilate.csh $
# $Revision: 11188 $
# $Date: 2017-03-03 14:16:35 -0800 (Fri, 03 Mar 2017) $
