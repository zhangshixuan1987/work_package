...
setenv CASE      'dart_e3sm_cntl_1.9x2.5_gx1v6_DT1800'
setenv CASEROOT  '/compyfs/zhan391/dart_e3sm_cam4/cases/dart_e3sm_cntl_1.9x2.5_gx1v6_DT1800'
setenv RUNDIR    '/compyfs/zhan391/dart_e3sm_cam4/run/dart_e3sm_cntl_1.9x2.5_gx1v6_DT1800'

setenv postCIME 5

set case_setup_script = '/compyfs/zhan391/run_script/dart_e3sm_test/create_and_setup_bundled_case.csh' 
...
#set stop_o   = 'nsteps'
set nlen      = 3 # run model for 5 years
set stop_o    = 'ndays'
...
set nl_file = /compyfs/zhan391/run_script/dart_e3sm_test/namelist_files/cam_nl_dart_e3sm_cntl
#====================================================================
