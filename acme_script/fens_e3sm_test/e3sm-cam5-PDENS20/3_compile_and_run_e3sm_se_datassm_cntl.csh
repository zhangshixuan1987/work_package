...
set casename = CNTL_ENS01_${COMPSET}_${RESOLUTION}_DT`printf "%04d" ${dtime}`
set MULTI_DRIVER = ' '
...
set dtime1      = 1800
set run_refcase = CNTL_ENS01_${COMPSET}_${RESOLUTION}_DT`printf "%04d" ${dtime1}`
set run_refdate = "2009-01-31"
set run_reftod  = "00000"
set initDir     = /compyfs/zhan391/cam5_datass_test/run/${run_refcase}/
