...
set irS = 4    # ensemble member: start index
...
set casename = HIND_5d_ENS20_${COMPSET}_${RESOLUTION}_DT`printf "%04d" ${dtime}`
set MULTI_DRIVER = ' '
...
if ($run_model > 0) then
  ...
  set dtime1      = 1800
  set run_refcase = DACAM5_ENS20_F20TRC5-AMIP_f19_g16_DT1800  
  set initDir     = ${INPUT_SPIN}/${run_refcase}/rest/$run_refdate-$run_reftod/
   ...
   set casename = HIND_5d_ENS20_F20TRC5-AMIP_f19_g16_DT`printf "%04d" ${dtime}`"_"${irstring}
