...
set casename = NDGERA5_ENS01_${COMPSET}_${RESOLUTION}_DT`printf "%04d" ${dtime}`
...
while ( $ir <= $irE )
  ...
  set run_reftod  = "00000"
  set dtime1      = 1800
  set run_refcase = NDGERA5_ENS01_F20TRC5-AMIP_f19_g16_DT1800
  ...
  ##set the reference data to be consistent with branch run information#
   ...
   set casename = PDHNDG_ERA5_ENS${irstring}_F20TRC5-AMIP_f19_g16_DT`printf "%04d" ${dtime}`
