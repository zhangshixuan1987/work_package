...
./create_newcase -case $CASEROOT -mach $MACH -project $PROJECT \
                 -res $RESOLUTION -compset $COMPSET -compiler $COMPILER --walltime $walltime
...
#./xmlchange -file env_run.xml   -id ICE_DOMAIN_PATH       -val "$CSMDATA//atm/cam/ocnfrac/"
#./xmlchange -file env_run.xml   -id ICE_DOMAIN_FILE       -val "domain.camocn.64x128_USGS_070807.nc"
...
cat <<EOF >> user_nl_cice
 grid_file = '/compyfs/inputdata//atm/cam/ocnfrac/domain.camocn.64x128_USGS_070807.nc'
 kmt_file = '/compyfs/inputdata//atm/cam/ocnfrac/domain.camocn.64x128_USGS_070807.nc'
EOF
