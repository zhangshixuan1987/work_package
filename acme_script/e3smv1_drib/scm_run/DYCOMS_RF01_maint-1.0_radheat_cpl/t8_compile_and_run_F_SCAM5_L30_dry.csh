...
setenv runcase   "DYCOMSrf01_dry_nolhflx"
...
setenv stop_n        24 # the forcing data tsec = 0, 345600 ;
...
cat <<EOF >> user_nl_cam
   ...
   use_gw_convect       = .true. 
   gw_drag_file         = '${CSMDATA}/atm/waccm/gw/newmfspectra40_dc25.nc'
   nhtfrq               =  1,-24,-3 
   mfilt                = 100000,10000,10000
   avgflag_pertape      = 'I', 'A','A'
   fincl1               = 'FUL', 'FDL'
EOF
