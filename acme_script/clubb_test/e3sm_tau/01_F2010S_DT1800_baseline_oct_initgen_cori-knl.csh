...
set e3sm_tag       = clubb_silhs_v2   # github tag or hash
set tag_name       = E3SM_tau

set clubb_vars_zt_list = "'tau_zt','thlm', 'thvm', 'rtm', 'rcm', 'rvm', 'um', 'vm', 'um_ref','vm_ref','ug', 'vg', 'cloud_frac', 'cloud_cover', 'rcm_in_layer', 'rcm_in_cloud', 'p_in_Pa', 'exner', 'rho_ds_zt', 'thv_ds_zt', 'Lscale', 'Lscale_pert_1', 'Lscale_pert_2', 'T_in_K', 'rel_humidity', 'wp3', 'wpthlp2', 'wp2thlp', 'wprtp2','wp2rtp', 'Lscale_up', 'Lscale_down', 'Kh_zt', 'wp2thvp', 'wp2rcp', 'wprtpthlp', 'sigma_sqd_w_zt', 'rho', 'radht', 'radht_LW', 'radht_SW', 'Ncm', 'Nc_in_cloud', 'Nc_activated', 'snowslope', 'sed_rcm', 'rsat', 'rsati', 'diam', 'mass_ice_cryst', 'rcm_icedfs', 'u_T_cm', 'rtm_bt', 'rtm_ma', 'rtm_ta', 'rtm_mfl', 'rtm_tacl', 'rtm_cl', 'rtm_forcing', 'rtm_sdmp','rtm_mc', 'rtm_pd', 'rvm_mc', 'rcm_mc', 'rcm_sd_mg_morr', 'thlm_bt', 'thlm_ma', 'thlm_ta', 'thlm_mfl', 'thlm_tacl', 'thlm_cl', 'thlm_forcing', 'thlm_sdmp','thlm_mc', 'thlm_old', 'thlm_without_ta', 'thlm_mfl_min', 'thlm_mfl_max', 'thlm_enter_mfl', 'thlm_exit_mfl', 'rtm_old', 'rtm_without_ta', 'rtm_mfl_min', 'rtm_mfl_max', 'rtm_enter_mfl', 'rtm_exit_mfl', 'um_bt', 'um_ma', 'um_gf', 'um_cf', 'um_ta', 'um_f', 'um_sdmp', 'um_ndg', 'vm_bt', 'vm_ma', 'vm_gf', 'vm_cf', 'vm_ta', 'vm_f', 'vm_sdmp', 'vm_ndg', 'wp3_bt', 'wp3_ma', 'wp3_ta', 'wp3_tp', 'wp3_ac', 'wp3_bp1', 'wp3_bp2', 'wp3_pr1', 'wp3_pr2', 'wp3_dp1', 'wp3_cl', 'mixt_frac', 'w_1', 'w_2', 'varnce_w_1', 'varnce_w_2', 'thl_1', 'thl_2', 'varnce_thl_1', 'varnce_thl_2', 'rt_1', 'rt_2', 'varnce_rt_1', 'varnce_rt_2', 'rc_1', 'rc_2', 'rsatl_1', 'rsatl_2', 'cloud_frac_1', 'cloud_frac_2', 'a3_coef_zt', 'wp3_on_wp2_zt', 'chi_1', 'chi_2', 'stdev_chi_1', 'stdev_chi_2', 'stdev_eta_1', 'stdev_eta_2', 'covar_chi_eta_1', 'covar_chi_eta_2', 'corr_chi_eta_1', 'corr_chi_eta_2', 'corr_rt_thl_1', 'crt_1', 'crt_2', 'cthl_1', 'cthl_2', 'precip_frac', 'precip_frac_1', 'precip_frac_2', 'Ncnm', 'wp2_zt', 'thlp2_zt', 'wpthlp_zt', 'wprtp_zt', 'rtp2_zt', 'rtpthlp_zt', 'up2_zt', 'vp2_zt', 'upwp_zt', 'vpwp_zt', 'C11_Skw_fnc'"
...
### CUSTOM CASE_NAME
set case_name = ${job_name}.${machine}.${tag_name}.${resolution}
...
### DIRECTORIES
  set code_root_dir               = /compyfs/zhan391/code
  set e3sm_simulations_dir        = /compyfs/zhan391/clubb_test_run_nudg
...
#Shixuan: copy the changes in the model_flag for CLUBB to perform sensitivity experiments 
set testfile  = $code_root_dir/$tag_name/clubb_upwind_test/model_flags.F90_$job_name
set modelfile = $code_root_dir/$tag_name/components/eam/src/physics/clubb/model_flags.F90

if( ! -f $testfile ) then
 echo "The test configuration file does not exist, please check!!"
 exit
else
 cp $testfile $modelfile
endif
...
set start_date                  = 0000-08-01# default
...
$xmlchange_exe PROJECT=$project,CHARGE_ACCOUNT=$project
$xmlchange_exe -file env_run.xml -id SAVE_TIMING_DIR -val $HOME
$xmlchange_exe -file env_workflow.xml -id JOB_QUEUE -val $queuename
...
cat <<EOF >> user_nl_cam 
 ...
 history_amwg         = .true.
 ncdata  = '/compyfs/zhan524/e3sm_scratch/ndata/alpha22/20200324_2f91b63_ERF.alpha22.F20TRC5-CMIP6.CLIM.ne30pg2_r05_oECv3.compy.cam.i.2010-08-01-00000.nc'
 nhtfrq =   0, 0,
 mfilt  =   1,  1,
 avgflag_pertape = 'A','A'

 fincl1 = 'U','PS','T','V','OMEGA','Z3','PRECT',
 ...
 fincl2               = $clubb_vars_zt_list, $clubb_vars_zt_list 
...
!---
 ...
 nudge_end_month        = 1
 nudge_end_year         = 9999
 nudge_file_template    = 'Freerun.compy.E3SM_tau.ne30_ne30.cam.h1.%y-%m-%d-00000.nc'
 nudge_path             = '/compyfs/zhan391/clubb_test_run_nudg/Freerun.compy.E3SM_tau.ne30_ne30/run/'
 nudge_pscoef           = 0.
 nudge_psprof           = 0
 nudge_qcoef            = 0.
 nudge_qprof            = 0
...
# fsurdat = "${input_data_dir}/lnd/clm2/surfdata_map/surfdata_0.5x0.5_simyr1850_c190418.nc"
# flanduse_timeseries = "${input_data_dir}/lnd/clm2/surfdata_map/landuse.timeseries_0.5x0.5_hist_simyr1850-2015_c191004.nc"
# finidat = '/compyfs/zhan524/e3sm_scratch/ndata/alpha22/20200324_2f91b63_ERF.alpha22.F20TRC5-CMIP6.CLIM.ne30pg2_r05_oECv3.compy.clm2.r.2010-08-01-00000.nc'
#EOF
...
#============================================
#time step and coupling frequency 
#============================================
@ ncpl = 86400 / $dtime

$xmlchange_exe  --id  ATM_NCPL          --val $ncpl
$xmlchange_exe  --id  CAM_NAMELIST_OPTS --val dtime=$dtime
$xmlchange_exe  --id  CLM_NAMELIST_OPTS --val dtime=$dtime
