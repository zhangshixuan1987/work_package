...
# Fetch code
####################################################################
setenv CCSMTAG E3SMv1_CLUBBv2_WSMTH
...
set casename = CLUBB_${COMPSET}_wsmth_DT`printf "%04d" ${dtime}`
...
###copy the required restart files to the directory for branch run#####
 ...
 # ./xmlchange  -file env_run.xml -id  RUN_STARTDATE  -val $start_date
  ...
  #
   ...
   ./xmlchange  -file env_workflow.xml    -id  JOB_WALLCLOCK_TIME -val "8:00:00"
