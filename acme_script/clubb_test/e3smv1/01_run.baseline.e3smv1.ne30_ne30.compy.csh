...
set e3sm_tag       = master 
set tag_name       = "ACME_master_20180611"
...
setenv INPUT_NUDGING /compyfs/zhan391/clubb_test_run_nudg/Freerun.e3smv1.F2010SC5-CMIP6.ne30_ne30.compy/run
 
set restart_case_name = "FC5AV1C-04P2_ne30_ne30_intel_cori-knl"
set restart_filedate  = "0001-08-01"
set restart_files_dir = "/compyfs/zhan391/acme_init/FC5AV1C-04P2_init_201907"

set atm_init   = ${restart_files_dir}/${restart_case_name}.cam.i.${restart_filedate}-00000.nc
set lnd_init   = ${restart_files_dir}/${restart_case_name}.clm2.r.${restart_filedate}-00000.nc
set ice_init   = ${restart_files_dir}/${restart_case_name}.cice.r.${restart_filedate}-00000.nc
...
cat <<EOF >> user_nl_cam
 ...
 !.......................................................
  ...
  Nudge_File_Template = 'case.cam.h1.%y-%m-%d-%s.nc'
