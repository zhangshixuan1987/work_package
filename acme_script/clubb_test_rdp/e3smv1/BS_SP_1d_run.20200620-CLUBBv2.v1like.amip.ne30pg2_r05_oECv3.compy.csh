...
### Floating point precision for CLUBB ##
setenv clubb_precision sp

### SOURCE CODE OPTIONS
set fetch_code     = false 
set e3sm_tag       = master 
set tag_name       = "E3SMv2_ORG_CLUBB"
set exp_name       = "bs_sigpre"
...
set e3sm_simulations_dir        = /compyfs/zhan391/clubb_test_rdp
...
$xmlchange_exe USER_REQUESTED_QUEUE=$queue
...
# PRECISION FOR CLUBB
#===========================
if ( `lowercase $clubb_precision` == sp ) then
  $xmlchange_exe --append CAM_CONFIG_OPTS="-clubb_opts=clubb_single_prec"
endif
