...
set mergeDist     = 9.0    # unit: degree, Minimum allowable distance between two candidates [0,10]degree
...
while ( $i <= $nzfil ) 
  ...
  $command0 --in_data_list $finput \
            ...
            --in_connect ${grdfil} \
            --searchbymin "${var_psl}" \
            --closedcontourcmd "${var_psl},${pslFOmag},${pslFOdist},0" \
            --noclosedcontourcmd "${varcmd}(${var_WC1},${var_WC2}),${wcFOmag},${wcFOdist},${wcMaxOffset}" \
            --mergedist ${mergeDist} \
