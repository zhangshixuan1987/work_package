...
set taskname = e3sm_convg_201910_test
...
set groupList = ("e3sm_v1_clubb_cold_ndrib")
set dtimeList = (1800 450 120 30 12 6 2 1)
set rsplit               = 3
set se_nsplit            = 2
set cld_macmic_num_steps = 6
set l_dribling           = ".false." 
set do_clubb_int         = ".false."
set do_output_clubb_int  = ".false."
...
if ($MACH == "titan") then
   ...
   set initDir = /global/cscratch1/sd/zhan391/acme_input/FC5AV1C-04P2_AQUAP_init_201907/
                 #/global/cscratch1/sd/zhan391/acme_input/FC5AV1C-04P2_init_201907/
   ...
   setenv CCSMROOT $WORKDIR/code/${CCSMTAG}
   setenv PTMP     $WORKDIR/e3sm_simulation/$taskname
   setenv EXELOC   $PTMP/exe
...
set case_setup_script = ${exp_setup_dir}/create_and_setup_bundled_cold.csh
...
if ($run_model > 0) then
  ...
  set atmInitList = (\
   ${initDir}'FC5AV1C-04P2-AQUAP_DT1800.cam.i.0001-01-01-00000.nc'\
   ${initDir}'FC5AV1C-04P2-AQUAP_DT1800.cam.i.0001-02-01-00000.nc'\
   ${initDir}'FC5AV1C-04P2-AQUAP_DT1800.cam.i.0001-03-01-00000.nc'\
   ${initDir}'FC5AV1C-04P2-AQUAP_DT1800.cam.i.0001-04-01-00000.nc'\
   ${initDir}'FC5AV1C-04P2-AQUAP_DT1800.cam.i.0001-05-01-00000.nc'\
   ${initDir}'FC5AV1C-04P2-AQUAP_DT1800.cam.i.0001-06-01-00000.nc'\
   ${initDir}'FC5AV1C-04P2-AQUAP_DT1800.cam.i.0001-07-01-00000.nc'\
   ${initDir}'FC5AV1C-04P2-AQUAP_DT1800.cam.i.0001-08-01-00000.nc'\
   ${initDir}'FC5AV1C-04P2-AQUAP_DT1800.cam.i.0001-09-01-00000.nc'\
   ${initDir}'FC5AV1C-04P2-AQUAP_DT1800.cam.i.0001-10-01-00000.nc'\
   ${initDir}'FC5AV1C-04P2-AQUAP_DT1800.cam.i.0001-11-01-00000.nc'\
   ${initDir}'FC5AV1C-04P2-AQUAP_DT1800.cam.i.0001-12-01-00000.nc'\
   )

  set lndInitList = (\
   ${initDir}'FC5AV1C-04P2-AQUAP_DT1800.clm2.r.0001-01-01-00000.nc' \
   ${initDir}'FC5AV1C-04P2-AQUAP_DT1800.clm2.r.0001-02-01-00000.nc' \
   ${initDir}'FC5AV1C-04P2-AQUAP_DT1800.clm2.r.0001-03-01-00000.nc' \
   ${initDir}'FC5AV1C-04P2-AQUAP_DT1800.clm2.r.0001-04-01-00000.nc' \
   ${initDir}'FC5AV1C-04P2-AQUAP_DT1800.clm2.r.0001-05-01-00000.nc' \
   ${initDir}'FC5AV1C-04P2-AQUAP_DT1800.clm2.r.0001-06-01-00000.nc' \
   ${initDir}'FC5AV1C-04P2-AQUAP_DT1800.clm2.r.0001-07-01-00000.nc' \
   ${initDir}'FC5AV1C-04P2-AQUAP_DT1800.clm2.r.0001-08-01-00000.nc' \
   ${initDir}'FC5AV1C-04P2-AQUAP_DT1800.clm2.r.0001-09-01-00000.nc' \
   ${initDir}'FC5AV1C-04P2-AQUAP_DT1800.clm2.r.0001-10-01-00000.nc' \
   ${initDir}'FC5AV1C-04P2-AQUAP_DT1800.clm2.r.0001-11-01-00000.nc' \
   ${initDir}'FC5AV1C-04P2-AQUAP_DT1800.clm2.r.0001-12-01-00000.nc' \
   )
   ...
   while ( $ig <= $igE )
    ...
    while ( $idtime <= $ndtime )
      ...
      while ( $ir <= $irE )
         ...
         ##set the reference data to be consistent with branch run information#
         set irstring = `printf "%02d" ${ir}`
         set run_refdate = "0001-$irstring-01"
         set run_reftod  = "00000"
...
set l_dribling           = '$l_dribling'
set do_clubb_int         = '$do_clubb_int'
set do_output_clubb_int  = '$do_output_clubb_int'

set rsplit               = '$rsplit'
set se_nsplit            = '$se_nsplit'
set cld_macmic_num_steps = '$cld_macmic_num_steps'
