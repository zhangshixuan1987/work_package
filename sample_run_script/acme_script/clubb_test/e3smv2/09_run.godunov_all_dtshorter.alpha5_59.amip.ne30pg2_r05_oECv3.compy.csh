...
set job_name       = alpha5_59.F2010
set compset        = F2010SC5-CMIP6
set resolution     = ne30pg2_r05_oECv3
set machine        = compy
set walltime       = 8:00:00
setenv project       esmd

### SOURCE CODE OPTIONS
set fetch_code     = false 
set e3sm_tag       = master 
set tag_name       = "E3SMv2_202012_alpha59"
set exp_name       = "godunov_all_dtshorter"

### CUSTOM CASE_NAME
set case_name = ${exp_name}.${job_name}.${resolution}.${machine}
...
set testfile  = $code_root_dir/$tag_name/clubb_upwind_test/model_flags.F90_$exp_name
...
### SIMULATION OPTIONS
set start_date                  = 0000-08-01 #default #1980-01-01
...
!---
 ...
 nudge_end_month        = 1
 nudge_end_year         = 9999
 nudge_file_template    = 'Freerun.alpha5_59.F2010.ne30pg2_r05_oECv3.compy.eam.h1.%y-%m-%d-00000.nc'
 nudge_path             = '/compyfs/zhan391/clubb_test_run_nudg/Freerun.alpha5_59.F2010.ne30pg2_r05_oECv3.compy/run/'
 nudge_pscoef           = 0.
 nudge_psprof           = 0
 nudge_qcoef            = 0.
 nudge_qprof            = 0
