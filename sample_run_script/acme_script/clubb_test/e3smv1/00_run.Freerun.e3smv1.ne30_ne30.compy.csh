...
set casename = Freerun.e3smv1.${COMPSET}.${RESOLUTION}.${MACH}
...
if ($compile_model > 0) then
   ...
   setenv CASE     $execase
   setenv CASEROOT ${PTMP}/cases
   setenv RUNDIR   ${PTMP}/run
