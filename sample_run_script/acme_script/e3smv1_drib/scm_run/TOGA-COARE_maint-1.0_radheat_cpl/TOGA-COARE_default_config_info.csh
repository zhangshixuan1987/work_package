...
setenv lat -2.10 # latitude
setenv lon 154.69 # longitude
...
setenv micro_nccons_val 70.0D6 # cons_droplet value for liquid
setenv micro_nicons_val 0.0001D6 # cons_droplet value for ice
setenv startdate 1992-12-18 # Start date in IOP file
setenv start_in_sec 64800 # start time in seconds in IOP file
#setenv stop_option   nhours
#setenv stop_n        96 # the forcing data tsec 0, 345600 ;
setenv iop_file TOGAII_iopfile_4scam.nc #IOP file name
