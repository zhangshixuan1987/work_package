...
set casename = NDDRIB_${COMPSET}_ORG_OCT_5day_DT`printf "%04d" ${dtime}`

#-----------------
#setup branch run information
set dtime1      = 1800 
set run_refcase = NDGDATA_FC5AV1C-L_org_DT1800
set run_refdate = "0001-10-01"
set run_reftod  = "00000"
set initDir     = /compyfs/zhan391/FC5AV1C-L_201806_initgen_84nodes/run/${run_refcase}/
