...
cat > user_nl_cam <<EOF
 ...
 ndens              = 1,
 empty_htapes       = .true.,
 fincl1             = 'PS', 'U', 'V', 'T', 'Q', 'CLDLIQ', 'LANDFRAC', 'DTCORE', 'PTTEND', 'RKZ_ql','RKZ_qv', 'RKZ_qsat', 'RKZ_RH', 'RKZ_f', 'RKZ_dfdRH', 'RKZ_term_A', 'RKZ_term_B', 'RKZ_term_C', 'RKZ_dfdt', 'RKZ_ql_incld','RKZ_Al', 'RKZ_Av', 'RKZ_AT', 'RKZ_zqme', 'RKZ_qme', 'RKZ_qme_lm4', 'RKZ_qme_lm5'
 ncdata             = '$atm_init'
 deep_scheme        = 'off',
 shallow_scheme     = 'off',
 l_tracer_aero      = .false.
