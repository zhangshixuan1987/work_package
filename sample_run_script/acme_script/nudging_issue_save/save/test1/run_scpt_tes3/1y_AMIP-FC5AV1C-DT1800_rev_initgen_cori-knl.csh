...
set casename = AMIP_WDRB_NUDG_${COMPSET}_DT`printf "%04d" ${dtime}`

#-----------------
#setup run information
set dtime1      = 1800 
set run_refcase = WDRB_NUDG_DATA_F20TRC5-CMIP6_DT`printf "%04d" ${dtime1}` 
set run_refdate = "2009-10-01"
set run_reftod  = "00000"
set initDir     = ${INPUT_NUDGING}/${run_refcase}/
set atm_file    = "${initDir}/${run_refcase}.cam.i.2009-10-01-00000.nc"
set lnd_file    = "${initDir}/${run_refcase}.clm2.r.2009-10-01-00000.nc"
...
!history_microphysics = .true.
 ...
 nhtfrq               =  0, -24
 mfilt                =  1, 1
 fincl2               = 'Nudge_U','Nudge_V','Nudge_T' 
! clubb_c14 = 1.06D0
! l_ieflx_fix = .false.
