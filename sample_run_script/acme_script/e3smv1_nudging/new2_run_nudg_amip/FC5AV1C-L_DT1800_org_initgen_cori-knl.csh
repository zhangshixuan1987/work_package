...
setenv INPUT_NUDGING /compyfs/zhan391/acme_init/NDRB_NUDG_DATA_F20TRC5-CMIP6_DT1800


set taskname = FC5AV1C-L_201806_initgen_84nodes
set casename = NDDRIB2_${COMPSET}_org_DT`printf "%04d" ${dtime}`

#-----------------
#setup branch run information
set dtime1      = 1800 
set run_refcase = NDRB_NUDG_DATA_F20TRC5-CMIP6_DT1800
set run_refdate = "2010-10-01"
set run_reftod  = "00000"
set initDir     = /compyfs/zhan391/acme_init/${run_refcase}/
