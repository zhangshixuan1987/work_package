...
# Fetch code
####################################################################
setenv CCSMTAG  e3sm_gmd2020_hui
...
###copy the required restart files to the directory for branch run#####
  ...
  #
   ...
   ./xmlchange  -file env_batch.xml -id USER_REQUESTED_QUEUE -val   $queue
...
!history_microphysics = .true.
 ...
 nhtfrq               = 0, 
 mfilt                = 1, 
 fincl1               = 'ZMT','ZMQ','ZMLIQ','ZMICE','MPDT','MPDLIQ','MPDQ','MPDICE',
                        'ZMDT','ZMDQ','ZMDLIQ','ZMDICE', "RVMTEND_CLUBB","RCMTEND_CLUBB", "STEND_CLUBB",
                        'GCLDLWP','TGCLDCWP','TGCLDLWP','TGCLDIWP','ICLDIWP','ICLDTWP',
                        'ICWMR','ICIMR','IWC','LWC','LS_ICWMR','CU_ICWMR','ICLMRCU','ICIMRCU','ICLMRTOT','ICIMRTOT',
                        'CLOUD','AST','ALST','AIST','CLOUDFRAC_CLUBB','CONCLD','DP_FRAC_CLUBB',
                        'ICWMRDP_CLUBB', 'ICWMRDP','CLDLIQ','CLDICE','CAPE','FREQZM','ZMMU','ZMMD',
                        'CMFMCDZM','CMFMCDZM_CLUBB','Skw_zt', "T_in_K", 'Skw_zm','rcm_in_cloud','rcm','rtm','rvm','thlm','wprtp','wpthlp',
                        'sh','lh','cc','lwp','z_inversion','z_cloud_base','wpthlp_sfc','wprtp_sfc','thlm_vert_avg','wp2_vert_avg',

 clubb_vars_zt       = $clubb_vars_zt
 clubb_vars_zm       = $clubb_vars_zm
 clubb_vars_sfc      = $clubb_vars_sfc
...
cat <<EOF >> user_nl_cam
 ...
 !.......................................................
  ...
  Nudge_Path   = '${initDir}/'
  Nudge_File_Template = '${run_refcase}.cam.h1.%y-%m-%d-%s.nc'
...
metric_name = 'ALL',
!
qoi_chkpt   = 'PBCDIAG', 'RAD', 'PACEND', 'DYNEND', 'DRYADJ', 'DEEPCU', 'BF_STCLD', 'STCLD',
              'CLDMAC01','CLDMIC01'
              'CLDMAC02','CLDMIC02'
              'CLDMAC03','CLDMIC03'
              'CLDMAC04','CLDMIC04'
              ...
              'CLDMAC06','CLDMIC06'
!
qoi_name = 'RHI', 'Q', 'QSATI',  'T', 'CLDLIQ', 'CLDICE', 'CAPE',
qoi_nver =  72,    72,      72,   72,       72,       72,      1,
!
l_output_state = .true.
l_output_incrm = .true.
!
