...
set test_casename  = AMIP_WDRB_NUDG_F20TRC5-CMIP6_DT1800
set test_filetype  = monthly_history
#set test_filetype = time_series
set diag_dir          =  /global/cscratch1/sd/zhan391/F20TRC5-CMIP6_NUDG_ISSUE
set test_path_history =  ${diag_dir}/data/$test_casename/
set test_path_climo   =  ${diag_dir}/climo/$test_casename/
set test_path_diag    =  ${diag_dir}/diag/$test_casename/
set test_path_HPSS    =  ${diag_dir}/compress/${test_casename}/atm/hist/
...
set cntl_casename   = WDRB_NUDG_DATA_F20TRC5-CMIP6_DT1800
set cntl_filetype   = monthly_history
#set cntl_filetype = time_series

set diag_dir          =  /global/cscratch1/sd/zhan391/F20TRC5-CMIP6_NUDG_ISSUE
set cntl_path_history =  ${diag_dir}/data/$cntl_casename/
set cntl_path_climo   =  ${diag_dir}/climo/$cntl_casename/
set cntl_path_HPSS    =  ${diag_dir}/compress/${cntl_casename}/atm/hist/
...
set test_first_yr = 2010       # first year (must be >= 1)
...
set cntl_first_yr = 2010    # first year (must be >= 1)
...
set test_name = "WDRIB_NDG"             # test case name 
set cntl_name = "WDRIB_FRE"               # control case name

#----------------------------------------------------------------
# Convert output postscrit files to GIF, JPG or PNG image files 
...
setenv DIAG_HOME "/global/cscratch1/sd/zhan391/climate_analysis/amwg_diag_20140804"
...
set email_address = "shixuan.zhang@pnnl.gov"
...
setenv swift_scratch_dir "/pic/scratch/zhan391/swift_scratch/"
set test_inst =  -1
set cntl_inst =  -1
...
echo  $test_path_history  $test_casename
