...
setenv INPUT_NUDGING /compyfs/zhan391/acme_init/ERA5_Reanalysis/era_to_e3sm/era_to_se
setenv initDir /compyfs/zhan391/acme_init

set casename = AMIP_ANL_UVNDG_6h_CLIMSST_${COMPSET}_DT`printf "%04d" ${dtime}`
...
###copy the required restart files to the directory for branch run#####
   ...
   ./xmlchange  -file env_run.xml -id SSTICE_DATA_FILENAME -val "/compyfs/zhan391/run_script/nudging_issue/nudging_to_era5_SST/sst_ice_CMIP6_DECK_E3SM_1x1_CLIM_c20210618.nc"
  ...
  #
   @ nmon = $dtime * 16 / 2000
   ./xmlchange  -file env_run.xml -id  STOP_N       -val '17'
...
cat <<EOF >> user_nl_cam
 ...
 !.......................................................
  ...
  Num_Slice    = 1
  Nudge_Path   = '${INPUT_NUDGING}/method4/'
  Nudge_File_Template = 'era5_ne30L72_%y-%m-%d-%s.nc'
