...
set irE = 20   # ensemble member: end   index
...
setenv INPUT_NUDGING /compyfs/zhan391/acme_init/ERA5_Reanalysis/era_to_e3sm/era_to_fv/method4
setenv NDG_DATA_NAM  era5_1.9x2.5L30

set taskname = cam5_datass_en20
set casename = PINDGERA5_ENS01_${COMPSET}_${RESOLUTION}_DT`printf "%04d" ${dtime}`
...
#set atm_init    = "/compyfs/zhan391/acme_init/pi_cam5_init/cesm1_2_2_f19_ens_EXP01.cam.i.0001-01-01-00000.nc"
#set lnd_init    = "${CSMDATA}/lnd/clm2/initdata_map/clmi.I1850GSWCNPRDCTCBC.f19_g16.67a0f98.0401-01-01-00000.nc"
...
while ( $ir <= $irE )
  ...
  set ndg_Ttau  = `echo "scale=16;$nday * 24 * 3600 + $ir * 0.1 * 24 * 3600" | bc`
  echo $ndg_Ttau
  set ndg_cof1  = `echo "scale=16; 1.0  * 21600 / $ndg_Ttau" | bc`
  set ndg_coef  = `printf "%10.5e" $ndg_cof1`
  ...
  set run_reftod  = "00000"
  set dtime1      = 1800
  set run_refcase = PINDGERA5_ENS01_F20TRC5-AMIP_f19_g16_DT1800
  set initDir     = /compyfs/zhan391/cam5_datass_en20/run/${run_refcase}/
  ...
  ##set the reference data to be consistent with branch run information#
   ...
   set casename = PIHNDG_ERA5_ENS${irstring}_F20TRC5-AMIP_f19_g16_DT`printf "%04d" ${dtime}`
...
cat <<EOF >> user_nl_cam
 ...
 !.......................................................
  ...
  Nudge_Loc    = .True.
  Nudge_Curr   = .False.
  Nudge_Z3thres= 10000.0
  Nudge_Zconstrain = .False.
  Num_Slice    = 1
  Nudge_Path   = '${INPUT_NUDGING}/'
  Nudge_File_Template = '${NDG_DATA_NAM}_%y-%m-%d-%s.nc'
