...
set casename = PIDACAM5_ENS20_${COMPSET}_${RESOLUTION}_DT`printf "%04d" ${dtime}`
set MULTI_DRIVER = ' '
...
set dtime1      = 1800
set run_refcase = PIDACAM5_ENS80_${COMPSET}_${RESOLUTION}_DT`printf "%04d" ${dtime1}`
set run_refdate = "2009-01-24"
