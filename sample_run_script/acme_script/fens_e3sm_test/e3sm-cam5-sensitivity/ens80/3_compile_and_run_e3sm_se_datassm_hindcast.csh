...
set dtime = 60
set nlen      = 15   # run model for 3 days
set stop_o    = 'ndays'
set ires      = 1   #
set rest_o    = 'nmonths'

set irS = 6    # ensemble member: start index
...
set taskname = cam5_datass_tsens
set MULTI_DRIVER = ' '
...
if ($run_model > 0) then
  ...
  set initDir     = ${INPUT_SPIN}/${run_refcase}/rest/$run_refdate-$run_reftod/
   ...
   set casename = HIND_15d_ENS80_F20TRC5-AMIP_f19_g16_DT`printf "%04d" ${dtime}`"_"${irstring}
  ...
  # Set sim length so that a cycle can be finished in 8 hours
   ...
   ./xmlchange  -file env_batch.xml -id JOB_WALLCLOCK_TIME -val "48:00:00"
