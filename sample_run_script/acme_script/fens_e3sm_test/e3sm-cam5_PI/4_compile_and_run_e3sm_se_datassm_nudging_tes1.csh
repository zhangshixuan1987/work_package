...
set casename = TS1_NDGERA_ENS01_${COMPSET}_${RESOLUTION}_DT`printf "%04d" ${dtime}`
set MULTI_DRIVER = ' '
...
cat <<EOF >> user_nl_cam
 ...
 !.......................................................
  ...
  Nudge_Clim   = .False.
  Nudge_Anls   = .True.
  Nudge_Method = 'Linear' !! this is not activate in FV dycore
  Nudge_Tau    = 6.0
  Nudge_Path   = '${INPUT_NUDGING}/'
  Nudge_File_Template = 'ecmwf_1.9x2.5L30_%y-%m-%d-%s.nc'
