...
set casename = PIDACAM5_ENS80_${COMPSET}_${RESOLUTION}_DT`printf "%04d" ${dtime}`
set MULTI_DRIVER = ' '
#if ($NDRIVERS > 1) set MULTI_DRIVER = ' --multi-driver '

#-----------------
#setup branch run information
setenv INPUT_SPIN /compyfs/zhan391/${taskname}/run
set dtime1      = 1800 
set run_refcase = PISPIN_ENS_${COMPSET}_${RESOLUTION}_DT`printf "%04d" ${dtime1}`
set run_refdate = "2009-01-07"
set run_reftod  = "00000"
set initDir     = ${INPUT_SPIN}/${run_refcase}/
