...
set taskname = e3sm_datass_test 
set casename = TEST_${COMPSET}_${RESOLUTION}_DT`printf "%04d" ${dtime}`
set MULTI_DRIVER = ' '
...
set atm_init    = /compyfs/zhan391/acme_init/ne30_FC5_L32/trunk-F2000climo-30yrs-C60topo.cam.i.0023-02-01-00000.nc 
                 #"${CSMDATA}/atm/cam/inic/homme/cami_mam3_Linoz_ne4np4_L72_c160909.nc"
...
#  ./xmlchange -file env_build.xml -id GMAKE_J -val '16'
   ...
   ./xmlchange -file env_build.xml -id CAM_CONFIG_OPTS -val "-phys cam5 -clubb_sgs -microphys mg2 -chem linoz_mam4_resus_mom_soag -rain_evap_to_coarse_aero -nlev 32 -bc_dep_to_snow_updates"
   #"-phys cam5 -clubb_sgs -microphys mg2 -chem linoz_mam4_resus_mom -rain_evap_to_coarse_aero -nlev 32 -clubb_sgs -microphys mg2 -chem linoz_mam4_resus_mom_soag -rain_evap_to_coarse_aero -nlev 32 -bc_dep_to_snow_updates"
   ./case.build
