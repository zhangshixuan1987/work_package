...
#setenv INPUT_NUDGING /compyfs/zhan391/acme_init/nudge_era_interim
#setenv NDG_DATA_NAM  ecmwf_1.9x2.5L30
...
set casename = NDGERAUVTQ_ENS01_${COMPSET}_${RESOLUTION}_DT`printf "%04d" ${dtime}`
set MULTI_DRIVER = ' '
