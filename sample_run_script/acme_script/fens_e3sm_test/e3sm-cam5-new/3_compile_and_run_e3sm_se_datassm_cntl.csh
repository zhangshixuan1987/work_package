...
set casename = CNTL_LONG_ENS01_${COMPSET}_${RESOLUTION}_DT`printf "%04d" ${dtime}`
set MULTI_DRIVER = ' '
...
cat > $user_cam <<EOF
 ...
 mfilt               = 1,
 ndens               = 1
 fincl1              = 'PSL','T200','T500','T850','U200','U500','U850','V200','V500','V850','Q200','Q500','Q850','RH200','RH500','RH850','OMEGA850','OMEGA500','OMEGA200','Z200','Z500','Z850','UBOT','VBOT','ZBOT','VBOT','TREFHT','T7001000','TH7001000','THE7001000'
