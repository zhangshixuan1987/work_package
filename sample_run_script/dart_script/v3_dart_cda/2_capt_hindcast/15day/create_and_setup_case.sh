...
export my_casename="CAPTEN${my_ensnum}_${my_leadtime}_${my_compset}_${my_resolution}_${my_machine}"
...
export my_dartymde="2012-02-01"   #end ymd of dart da
