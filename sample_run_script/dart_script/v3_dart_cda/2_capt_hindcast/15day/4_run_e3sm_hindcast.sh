...
#SBATCH  --job-name=e3sm_hindcast_cyc 
#SBATCH  --nodes=1
#SBATCH  --output=e3sm_hindcast_cyc.%j 
#SBATCH  --exclusive
#SBATCH  --no-kill
#SBATCH  --requeue
...
echo == Start of 4_run_e3sm_hindcast.sh ==
date
echo ============================================
...
for i in `seq 1 ${my_ensnum}`;do
  ...
  ./xmlchange STOP_N="2"
  ./xmlchange NTASKS="${my_dart_ntask}"
...
echo ===== End of 4_run_e3sm_hindcast.sh =====
date
echo =====================================
