...
set Cases  = (e3sm_v2_NDGERA5_PL_UV3_tau06_F20TR_ne30pg2_EC30to60E2r2 \
              e3sm_v2_NDGERA5_PL_UVT3_tau06_F20TR_ne30pg2_EC30to60E2r2 \
              e3sm_v2_NDGERA5_PL_UVTQ3_tau06_F20TR_ne30pg2_EC30to60E2r2 )   
...
while ( $i <= 1 ) #$ncase )
 ...
 set OUT_DIR_SE    = /global/cfs/cdirs/e3sm/www/zhan391/darpa_temporary_data_share/SE_PG2/nudging_tendency
 set OUT_DIR_FV    = /global/cfs/cdirs/e3sm/www/zhan391/darpa_temporary_data_share/FV_180x360/nudging_tendency
 ...
 while ($year <= 2012)
  ...
  set timstr  = "${year}01010300-${year}12311800"
