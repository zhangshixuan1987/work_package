...
set Outnam = (E3SMv2_NDGUVTQ_SRF1_tau6)
set ncase  = $#Outnam
...
while ( $i <= $ncase )
 ...
 set RUN_FILE_DIR  = /global/cfs/cdirs/e3sm/www/zhan391/darpa_temporary_data_share/SE_PG2/before_nudging_old
 set OUT_DIR_SE    = /global/cfs/cdirs/e3sm/www/zhan391/darpa_temporary_data_share/SE_PG2/before_nudging
 set OUT_DIR_FV    = /global/cfs/cdirs/e3sm/www/zhan391/darpa_temporary_data_share/FV_180x360/before_nudging
