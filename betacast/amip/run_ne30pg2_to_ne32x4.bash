...
mesh_dir="/global/cfs/cdirs/e3sm/www/zhan391/betacase_v3_narrm/rgd_maps"
in_mesh="ne30"
out_mesh="northamericax4v1"
mlev=80

inputdir="/global/cfs/cdirs/e3sm/www/zhan391/betacase_v3_narrm/amip"
date="1990-01-01-00000"
atm_in="${inputdir}/v3.LR.amip_0101.eam.i.${date}.nc"
...
betacast="/pscratch/sd/z/zhan391/SEACROGS_project/e3sm_model/betacast/atm_to_cam"
cd ${betacast}
#echo $date
...
outfil="${inputdir}/v3.LR.amip_0101.${out_mesh}.eam.i.${date}.nc"
